...
EMAIL_PORT = 587
# 发送邮件的邮箱
EMAIL_HOST_USER = 'maxhjh@qq.com'
# 在邮箱中设置的客户端授权密码
EMAIL_HOST_PASSWORD = 'lzrsnbffnctzbffi'
# 收件人看到的发件人
EMAIL_FROM = 'Blog<maxhjh@qq.com>'

DEFAULT_FROM_EMAIL = 'maxhjh@qq.com'

# 设置debug=false 未处理异常邮件通知
ADMINS = [('doublehuang', 'maxhjh@outlook.com')]
